...
<div class="screenright">
    <!--Add new address-->
        ...
        <form id="form2" method="post" action="dobilling.php"> 
        <fieldset id="billing">
        <legend>Add a new billing address</legend>

        <ul id="billingul">
            <li> <label title="BAddressID" for="BAddressID">Billing Address ID </label> <input type="text" name="BAddressID" id="BAddressID" size="30" maxlength="30"/></li>
            <li> <label title="BName" for="Bname">Name </label> <input type="text" name="Bname" id="Bname" size="30" maxlength="30"/></li>
            <li> <label title="BAddress1" for="Baddress1">Address 1 </label> <input type="text" name="Baddress1" id="Baddress1" size="30" maxlength="30" /></li>
            <li> <label title="BAddress2" for="Baddress2">Address 2 </label> <input type="text" name="Baddress2" id="Baddress2" size="30" maxlength="30" /></li>
            <li> <label title="BCity" for="Bcity">City </label> <input type="text" name="Bcity" id="Bcity" size="30" maxlength="30" /></li>
            <li> <label title="BState" for="Bstate">State </label> <input type="text" name="Bstate" id="Bstate" size="30" maxlength="30"/></li>
            <li > <label title="BZip" for="Bzip">Zip Code </label> <input type="text" name="Bzip" id="Bzip" size="30" maxlength="5"/></li>
            <li > <label title="BCardType" for="BCardType">Card type </label> <select name="Boption" id="Boption">
                <option selected value="selected">Choose a card type</option>
                <option value="VISA">VISA</option>
                <option value="American Express">American Express</option>
                <option value="MasterCard">MasterCard</option>
                <option value="Discover">Discover</option>
              </select></li>
            <li> <label title="BNumber" for="BNumber">Card number </label> <input type="text" name="Bnumber" id="Bnumber" size="30" maxlength="30" /></li>
            <li> <label title="BExp" for="BExp">Exp. Date </label><input type="text" name="BExp" id="BExp" size="30" maxlength="4" /> </li>
        ...
        <div id="errorMsg"><?php if(isset($_SESSION["errorMessage"])){echo($_SESSION["errorMessage"]); unset($_SESSION["errorMessage"]);} ?>
            ...
            <input id="BSubmitBtn" name="SubmitBtn" type="submit" width="30px"  value="Add billing address" />   
    </fieldset>
</form>
</div>
